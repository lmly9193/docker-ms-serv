...
function action(mode, type, selection) {
	...
	if (status == 0) {
	    ...
	    cm.sendNextPrev("亞蘭夥伴...? 好吧... 他們去和#b黑魔法師#k戰鬥了.當我們準備要逃跑時，它們決定和黑魔法師戰鬥並且封印他.什麼!?你想加入他們?不行!沒辦法，你已經受傷了你應該要上船跟我們一起走...");
	} else if (status == 3) {
	...
	if (status == 0) {
	    ...
	    switch (selection) {
		case 0:
		    cm.sendOk("我聽說現在#b黑魔法師#k正在靠近我們的地方.因為#b黑魔法師#k控制了所有龍的關係，甚至不可能從森林逃出.正因為這樣，所以我們才想出利用方舟作為我們的逃生路線.離開這裡的唯一方法就是飛往#b維多利亞島#k.");
		    break;
		case 1:
		    cm.sendOk("在方舟上的每一個人，都準備好離開這個地方了.當人都上船了，我們就要立刻前往#b維多利亞島#k.在空中神鳥會保護我們.");
		    break;
		case 2:
		    cm.sendOk("你的夥伴...為了幫助我們有足夠的時間逃離這，已經去和#b黑魔法師#k戰鬥了.他們決定不讓你去，因為你受傷了，他們希望妳可以和我們一起離開.亞蘭!一旦救了孩子，你應該和我們一起離開.");
		    break;
	    }
	    cm.safeDispose();
	}
